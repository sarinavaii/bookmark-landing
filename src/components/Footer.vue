<template>
    <footer>
        <nav class="navbar">
            <div class="container-xl flex-lg-row flex-column align-items-center gap-5">
                ...
                <ul class="navbar-nav flex-lg-row flex-column gap-lg-5 gap-3 flex-grow-1">
                    <li v-for="(page, index) in pages" :key="index" class="nav-item">
                        <a class="nav-link" href="#">{{ page }}</a>
                    </li>
                </ul>
                <div class="social-links d-flex gap-lg-5 gap-4">
                    <a href="#">
