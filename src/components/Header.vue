    ...
    <header>
        <nav class="navbar navbar-expand-md">
            <div class="container-xl">
                ...
                <Button class="navbar-toggler pure" data-bs-toggle="offcanvas" data-bs-target="#navbar-offcanvas">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="15">
                        <path fill="#242A45" fill-rule="evenodd" d="M0 0h18v3H0V0zm0 6h18v3H0V6zm0 6h18v3H0v-3z" />
                    </svg>
                </Button>
                <div class="offcanvas offcanvas-end navbar-offcanvas" id="navbar-offcanvas">
                    <div class="offcanvas-header">
                        ...
                        <Button class="pure" data-bs-dismiss="offcanvas">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <Button href="#" class="button-red button-login">login</Button>
                            </li>
                        </ul>
...
@media (max-width: 767px) {
    ...
    .navbar-nav {
        ...
        .nav-item {
            ...
            text-align: center;
            padding: 0.75rem 0;
            border-top: 1px solid hsla(229, 8%, 60%, 0.3);
        }
        .nav-link {
            font-size: 1.125rem;
            font-weight: 300;
